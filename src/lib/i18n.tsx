...
const dict: Dict = {
  ...
  "nav.albums": { ar: "ألبوم الصور", en: "Photo Albums" },
  "nav.videoAlbums": { ar: "ألبوم الفيديو", en: "Video Albums" },
  "nav.contact": { ar: "تواصل معنا", en: "Contact" },
  "nav.donate": { ar: "تبرع الآن", en: "Donate Now" },
  "nav.faq": { ar: "الأسئلة الشائعة", en: "FAQ" },
  "admin.donations": { ar: "التبرعات", en: "Donations" },
  "admin.faq": { ar: "الأسئلة الشائعة", en: "FAQ" },
  ...
  "admin.articles": { ar: "المقالات", en: "Articles" },
  "admin.albums": { ar: "ألبوم الصور", en: "Photo Albums" },
  "admin.videoAlbums": { ar: "ألبوم الفيديو", en: "Video Albums" },
